...
class Blur2(BaseShader):
    def __init__(self,vs_path="shader/blur2.vs",fs_path="shader/blur2.fs",weightoffset=0.0046296,heightoffset=0.0):
        super().__init__(vs_path="shader/blur2.vs",fs_path="shader/blur2.fs",weightoffset=0.0046296,heightoffset=0.0)
