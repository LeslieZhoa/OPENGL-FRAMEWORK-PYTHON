...
class Blur3(BaseShader):
    def __init__(self,vs_path="shader/blur3.vs",fs_path="shader/blur3.fs",weightoffset=0.0,heightoffset=0.0017361111):
        super().__init__(vs_path="shader/blur3.vs",fs_path="shader/blur3.fs",weightoffset=0.0,heightoffset=0.0017361111)
        

    def runFbo(self, width, height, textureId, outFboId,returnImage,att1):
        # 绑定纹理，常量
        self.samplerLoc_img = self.get_uniform("srcImageTex")
